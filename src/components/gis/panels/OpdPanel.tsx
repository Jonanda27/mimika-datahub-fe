...
/**
 * OpdPanel - GFW Paradigm (High-Density Data & Solid UI)
 * Menggantikan CategoryPanel untuk memfokuskan UX pada filter berbasis Instansi/OPD.
...
export default function OpdPanel() {
    ...
    // Ikon disesuaikan dengan "Rumpun OPD" yang baru
    const opdGroupIcons: Record<number, any> = {
        1: Building2, // Rumpun Pelayanan Dasar
        2: Map,       // Rumpun Infrastruktur & Wilayah
        3: Briefcase, // Rumpun Ekonomi & Pariwisata
    };

    const filteredGroups = useMemo(() => {
        if (!searchQuery) return MOCK_ATLAS_CATEGORIES;
        return MOCK_ATLAS_CATEGORIES.map(group => ({
            ...group,
                    ...
                    filteredGroups.map((group) => {
                        ...
                        return (
                            <div key={group.category_id} className="flex flex-col">
                                ...
                                {/* Rumpun OPD Header - Rapat dan Solid (Aturan Densitas) */}
                                ...
                                {/* Instansi List - Flexbox Row (Toggle UI) */}
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    {/* Label OPD (Tipografi Reguler/Medium) */}
                                                    <span
