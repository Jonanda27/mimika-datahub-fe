      ...
      try {
        ...
        if (fileExt === 'xlsx' || fileExt === 'xls') {
          ...
          if (fileExt === 'csv') {
            ...
            // Pratinjau sederhana untuk Dokumen
            setPreviewHeaders(["Tipe Dokumen", "Status Pembacaan"]);
            setPreviewData([{
              "Tipe Dokumen": fileExt.toUpperCase(),
              "Status Pembacaan": "Dokumen Terdeteksi (Pratinjau isi tidak tersedia untuk format non-tabular)"
            }]);
          }
        }
      } catch (err) {
  ...
  return (
    <div className="space-y-4 text-black">
      <div
        ...
        onDrop={handleDrop}
        className={`bg-white rounded-3xl p-10 flex flex-col items-center justify-center border-2 border-dashed transition-all cursor-pointer ${isProcessing ? "opacity-50 cursor-not-allowed" : ""
