      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <input 
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e61d0] transition-all text-black placeholder:text-black"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="space-y-1.5">
            ...
            <input name="year" type="number" defaultValue="2025" required disabled={isProcessing} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e61d0] text-black placeholder:text-black" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="flex items-end pb-1 italic text-[10px] text-gray-400">
            * Pastikan format file sesuai standar template
          </div>
        </div>

        <div className="space-y-1.5">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Deskripsi</label>
          <textarea name="description" rows={2} disabled={isProcessing} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e61d0] resize-none text-black placeholder:text-black" placeholder="Jelaskan isi dataset ini..."></textarea>
        </div>
