...
interface DatasetFormProps {
  ...
  // [INTEGRASI OPD-USER BINDING] Menambahkan properti opsional baru untuk sinkronisasi penguncian instansi [1]
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="space-y-1.5">
            ...
            {/* [INTEGRASI OPD-USER BINDING] Menolak manipulasi data dengan mengunci dropdown instansi bagi operator [1] */}
            <select
              name="source_id"
              required
              ...
              onChange={lockedSourceId ? () => { } : undefined} // Dummy handler untuk membungkam React controlled warning
            ...
            {/* Sembunyikan tombol penambahan sumber jika status dropdown terikat [1] */}
