...
export default function UploadDataPage() {
  ...
  const handleFileChange = (file: File) => {
    ...
    // Best practice: Use 20MB limit as per v2.0 Ingest Engine
  ...
  const handleUpload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Menggabungkan request data dari kedua branch
    const requestData = {
      ...
      file: selectedFile,
      image: selectedImage // Fitur dari branch teman
    };
    ...
    try {
      // Menggunakan action executeUpload dari Store (Best practice abstractions)
      ...
      // Delay sedikit sebelum menutup info alert agar user sempat membaca
